...
const config = convict({
  ...
  accessTokenUrl: {
    ...
    format: "url",
    default:
      process.env.KIBO_ACCESS_TOKEN_URL ||
      "https://home.mozu.com/api/platform/applications/authtickets/oauth",
...
try {
  ...
  console.warn(
    "[Kibo: Middleware Config] Not found any configuration file, will use the ENV variable or default configuration."
  );
}
